...
```{r plot_density_vs_normal, echo = FALSE}
  ...
  ggplot(data.frame(mean = y.means), aes(x = mean)) +
    ...
    geom_vline(xintercept = 5, 
      colour = "#dd8844", linetype = "dashed", size = 1.5) +
    geom_vline(xintercept = mean(y.means), 
      colour = "#44aadd", linetype = "dashed", size = 1.5) +
    geom_vline(xintercept = 5 + sqrt(25/40),
      colour = "#dd8844", linetype = "dashed", size = 1.5) +
    geom_vline(xintercept = 5 - sqrt(25/40),
      colour = "#dd8844", linetype = "dashed", size = 1.5) +
    geom_vline(xintercept = mean(y.means) + sqrt(var(y.means)),
      colour = "#44aadd", linetype = "dashed", size = 1.5) +
    geom_vline(xintercept = mean(y.means) - sqrt(var(y.means)),
      colour = "#44aadd", linetype = "dashed", size = 1.5)
```
